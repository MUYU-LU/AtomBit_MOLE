...
class Dataset:
    ...
    def to_datapipe(self) -> Any:
        r"""Converts the dataset into a :class:`DatasetAdapter`.

        The returned instance can then be used with :mindgeometric:`MindGeometric's` built-in
        :class:`DataPipes` for baching graphs as follows:

        .. code-block:: python

            from sharker.datasets import QM9
            ...
            for batch in dp:
                pass
        """
        from .datapipe import DatasetAdapter
